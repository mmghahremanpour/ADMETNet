...
@dataclass
class xmgrace_params:
   learning_curve:str = """# Grace project file
#
@version 50124
@page size 576, 576
@page scroll 5%
...
@with g0
@    znorm 1
@    view 0.115909, 0.150000, 0.888636, 0.850000
@    title ""
@    title font 0
@    title size 1.500000
@    title color 1
...
@    s0 comment "learning_curve.xvg"
@    s0 legend  "Training set"
@    s1 hidden false
@    s1 type xy
@    s1 symbol 0
